...
describe('GeoCodeService', () => {
  ...
  const addressResponseStub = {
    ...
    lon: '-21.9349374',
    display_name:
      'Lækjartorg B, Hverfisgata, Austurbær, Miðborg, Reykjavik, Capital Region, 101, Iceland',
    address: {
      highway: 'Lækjartorg B',
      road: 'Hverfisgata',
      neighbourhood: 'Austurbær',
      suburb: 'Miðborg',
      city: 'Reykjavik',
    ...
    boundingbox: ['64.1474838', '64.1475838', '-21.9349874', '-21.9348874'],
  }
